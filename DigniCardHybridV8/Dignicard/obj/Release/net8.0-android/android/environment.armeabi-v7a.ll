...
@dso_cache = dso_local local_unnamed_addr global [674 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 4530905, ; hash 0x4522d9, from name: libaot-ZXing.SkiaSharp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 405408830, ; hash 0x182a0c3e, from name: libaot-Dignicard
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 686629077, ; hash 0x28ed20d5, from name: libaot-BlazorBarcodeScanner.ZXing.JS
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 792954411, ; hash 0x2f43862b, from name: aot-BlazorBarcodeScanner.ZXing.JS
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BlazorBarcodeScanner.ZXing.JS.dll.so
		ptr null; void* handle (0x0)
	}, ; 108
	...
	%struct.DSOCacheEntry {
		i64 818361098, ; hash 0x30c7330a, from name: aot-ZXing.SkiaSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.71_name, ; name: libaot-ZXing.SkiaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 113
	...
	%struct.DSOCacheEntry {
		i64 1124933880, ; hash 0x430d20f8, from name: Dignicard.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dignicard.dll.so
		ptr null; void* handle (0x0)
	}, ; 162
	...
	%struct.DSOCacheEntry {
		i64 1810552111, ; hash 0x6bead52f, from name: aot-Dignicard
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dignicard.dll.so
		ptr null; void* handle (0x0)
	}, ; 263
	...
	%struct.DSOCacheEntry {
		i64 1929918906, ; hash 0x730839ba, from name: aot-BlazorBarcodeScanner.ZXing.JS.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BlazorBarcodeScanner.ZXing.JS.dll.so
		ptr null; void* handle (0x0)
	}, ; 284
	...
	%struct.DSOCacheEntry {
		i64 2135515847, ; hash 0x7f4962c7, from name: libaot-Dignicard.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dignicard.dll.so
		ptr null; void* handle (0x0)
	}, ; 317
	...
	%struct.DSOCacheEntry {
		i64 2488308573, ; hash 0x9450935d, from name: ZXing.SkiaSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.71_name, ; name: libaot-ZXing.SkiaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 383
	...
	%struct.DSOCacheEntry {
		i64 2626051740, ; hash 0x9c865e9c, from name: libaot-ZXing.SkiaSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.71_name, ; name: libaot-ZXing.SkiaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 406
	...
	%struct.DSOCacheEntry {
		i64 2720851842, ; hash 0xa22ce782, from name: ZXingBlazor
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2850358145, ; hash 0xa9e50381, from name: BlazorBarcodeScanner.ZXing.JS.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BlazorBarcodeScanner.ZXing.JS.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
	...
	%struct.DSOCacheEntry {
		i64 2989693095, ; hash 0xb23318a7, from name: libaot-ZXingBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-ZXingBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 475
	...
	%struct.DSOCacheEntry {
		i64 3330690927, ; hash 0xc6864f6f, from name: ZXing.SkiaSharp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.71_name, ; name: libaot-ZXing.SkiaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 529
	...
	%struct.DSOCacheEntry {
		i64 3593483832, ; hash 0xd6303638, from name: libaot-ZXingBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-ZXingBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 565
	...
	%struct.DSOCacheEntry {
		i64 3801346010, ; hash 0xe293efda, from name: aot-ZXing.SkiaSharp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.71_name, ; name: libaot-ZXing.SkiaSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 594
	...
	%struct.DSOCacheEntry {
		i64 3827320087, ; hash 0xe4204517, from name: aot-ZXingBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-ZXingBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 600
	...
	%struct.DSOCacheEntry {
		i64 3843337390, ; hash 0xe514acae, from name: libaot-BlazorBarcodeScanner.ZXing.JS.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BlazorBarcodeScanner.ZXing.JS.dll.so
		ptr null; void* handle (0x0)
	}, ; 604
	%struct.DSOCacheEntry {
		i64 3870474158, ; hash 0xe6b2bfae, from name: BlazorBarcodeScanner.ZXing.JS
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-BlazorBarcodeScanner.ZXing.JS.dll.so
		ptr null; void* handle (0x0)
	}, ; 605
	...
	%struct.DSOCacheEntry {
		i64 4009294479, ; hash 0xeef8fa8f, from name: aot-ZXingBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-ZXingBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 630
	...
	%struct.DSOCacheEntry {
		i64 4060797694, ; hash 0xf20adafe, from name: aot-Dignicard.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dignicard.dll.so
		ptr null; void* handle (0x0)
	}, ; 638
	...
	%struct.DSOCacheEntry {
		i64 4092525758, ; hash 0xf3eefcbe, from name: Dignicard
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dignicard.dll.so
		ptr null; void* handle (0x0)
	}, ; 641
	...
	%struct.DSOCacheEntry {
		i64 4238023995, ; hash 0xfc9b1d3b, from name: ZXingBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-ZXingBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 663
